...
f.status};for(var m in a){var d=a[m];c.CompletedFiles[m]=d;"r"!=c.Action&&"a"!=c.Action||"undefined"!=typeof d.error||b.file.IO({NodeData:"internal",Files:m,Action:"w",ContentOrDestinationNodes:d})}b.devices.cloud.fireCallback(c.Callback,c.CompletedFiles,c.CallbackData)}}.bind(b,c);f.open("POST",b.Callback,!0);f.send(JSON.stringify(a))}else"r"!==c.Action&&(a=Object.keys(c.CompletedFiles),c.PendingFiles.push(a)),b.queuer.AddItem({NodeData:c.NodeData,Action:c.Action,PendingFiles:c.PendingFiles,CompletedFiles:{},
...
(function(b){(function(d){d.Init=function(){b.file.IO({NodeData:"internal",Action:"e",Files:"ioQueue",Callback:function(a){0==a.ioQueue.status&&b.file.IO({NodeData:"internal",Action:"w",Files:"ioQueue",ContentOrDestinationNodes:{}})}});document.addEventListener("online",b.queuer.Process,!1);document.addEventListener("offline",b.queuer.ToggleStatus,!1)};d.ToggleStatus=function(){b.Online=!1};d.Process=function(){b.file.IO({NodeData:"internal",Action:"r",Files:"ioQueue",Callback:function(a){a=a.ioQueue;
b.Online=!0;for(var c in a){var d=a[c].NodeData,f=a[c].Action,e=a[c].ContentOrDestinationNodes;if(b.Online)b.file.IO({NodeData:d,Action:f,Files:c,ContentOrDestinationNodes:e}),delete a[c];else break}b.file.IO({NodeData:"internal",Action:"u",Files:"ioQueue",ContentOrDestinationNodes:a})}})};d.AddItem=function(a){b.file.IO({NodeData:"internal",Action:"r",Files:"ioQueue",Callback:function(c,a){c=c.ioQueue;for(var d=a.uniqueIOObject,e=0,g=d.Files;e<g.length;e++){var h=g[e];1==c.hasOwnProperty(h)&&delete c[h];
var l={NodeData:d.NodeData,Action:d.Action,Files:d.Files};"w"==d.Action&&(l.ContentOrDestinationNodes=d.ContentOrDestinationNodes);c[h]=l}b.file.IO({NodeData:"internal",Action:"u",Files:"ioQueue",ContentOrDestinationNodes:c})},CallbackData:{uniqueIOObject:a}})}})(b.queuer||(b.queuer={}))})(metis||(metis={}));
